...
/**
 * This is a file that is used to define unions for definitions
 * between inconvertible types (float and int for example).
 */
...
typedef union __se_float64
{
    ...
    __se_uint16  m_UHalfs[4];
    __se_uint32  m_AsUInt32[2];
    __se_uint64  m_AsUInt64;
    __se_int8    m_Bytes[8];
    __se_int16   m_Halfs[4];
    __se_int32   m_AsInt32[2];
    __se_int64   m_AsInt64;
