...
{ \
    ...
    { \
        SAVANNA_FATAL_LOG("Vk Runtime Error: " #func " returned result {}. {}", Savanna::Vk::VkResultUtils::ToString(__result__), msg); \
...
#define VK_CALL(result, func, msg) \
    ...
    { \
        SAVANNA_WARNING_LOG("Vk Runtime Error: " #func " returned result {}. {}", Savanna::Vk::VkResultUtils::ToString(result), msg); \
    }
