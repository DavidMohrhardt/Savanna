 ...
 */
#define SAVANNA_INTERFACE_ALLOCATE(__allocatorPtr, __size, __userDataPtr) \
    (*static_cast<se_AllocatorInterface_t*>(__allocatorPtr)).m_AllocFunc(__size, __userDataPtr)
 ...
 */
#define SAVANNA_INTERFACE_ALLOCATE_ALIGNED(__allocatorPtr, __size, __alignment, __userDataPtr) \
    (*static_cast<se_AllocatorInterface_t*>(__allocatorPtr)).m_AllocAlignedFunc(__size, __alignment, __userDataPtr)

#define SAVANNA_INTERFACE_FREE(__allocatorPtr, __ptr, __userDataPtr) \
    (*static_cast<se_AllocatorInterface_t*>(__allocatorPtr)).m_FreeFunc(__ptr, __userDataPtr)

#define SAVANNA_INTERFACE_REALLOCATE(__allocatorPtr, __ptr, __newSize, __userDataPtr) \
    (*static_cast<se_AllocatorInterface_t*>(__allocatorPtr)).m_ReallocFunc(__ptr, __newSize, __userDataPtr)

#define SAVANNA_INTERFACE_REALLOCATE_ALIGNED(__allocatorPtr, __ptr, __alignment, __newSize, __userDataPtr) \
    (*static_cast<se_AllocatorInterface_t*>(__allocatorPtr)).m_ReallocAlignedFunc(__ptr, __alignment, __newSize, __userDataPtr)
